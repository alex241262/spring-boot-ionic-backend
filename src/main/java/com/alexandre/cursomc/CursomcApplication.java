...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Escritorio3");
		Categoria cat4 = new Categoria(null, "Escritorio4");
		Categoria cat5 = new Categoria(null, "Escritorio5");
		Categoria cat6 = new Categoria(null, "Escritorio6");
		Categoria cat7 = new Categoria(null, "Escritorio7");
		Categoria cat8 = new Categoria(null, "Escritorio8");
		Categoria cat9 = new Categoria(null, "Escritorio9");
		Categoria cat10 = new Categoria(null, "Escritorio10");
		...
		p1.getCategoias().addAll(Arrays.asList(cat1));
		p2.getCategoias().addAll(Arrays.asList(cat1, cat2));
		p3.getCategoias().addAll(Arrays.asList(cat1));
		...
		Endereco e1= new Endereco(null, "Rua Flores", "300", "Apt 303", "Jardin", "38220834", cli1, c1);
		Endereco e2= new Endereco(null, "Avenica Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
